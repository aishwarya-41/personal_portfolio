...
const PROJECTS = [
  ...
  {
    id: "sign-detector",
    title: "Sign Detector Web Application",
    summary: "A deep learning-based web application that detects and translates road signs from uploaded images using CNN and OCR.",
    tech: ["Python", "TensorFlow/Keras", "OpenCV", "OCR", "Flask/Django", "HTML/CSS"],
    image: "/project/project11.png",
    github: "https://github.com/aishwarya-41/sign_detector",
    description: "A deep learning-based web application that detects and translates road signs from uploaded images. The app integrates a Convolutional Neural Network (CNN) model for sign recognition, Optical Character Recognition (OCR) for text extraction, and translation support for multiple languages. It aims to assist drivers and travelers in understanding road signs in foreign languages.",
    features: [
      "Detects road signs from uploaded images using a trained CNN model.",
      "Extracts text from signs using OCR technology.",
      "Translates detected text into multiple languages.",
      "User-friendly web interface for image upload and result display.",
      "Integrates deep learning with practical utility for travelers."
    ]
  },
  {
  id: "medical-report-analyzer",
  title: "Medical Report Analyzer Web Application",
  summary: "A full-stack AI web application that analyzes uploaded medical reports (PDFs), extracts lab values, highlights abnormalities, and answers user queries using a Retrieval-Augmented Generation (RAG) pipeline.",
  tech: [
    "Python",
    "Flask",
    "React",
  ...
  github: "https://github.com/aishwarya-41/medical_report_analysis",
  description: "A full-stack AI-powered web application that simplifies understanding of medical lab reports. Users can upload a PDF report to automatically extract lab parameters, identify out-of-range values, and ask natural language questions about the report using a Retrieval-Augmented Generation (RAG) pipeline.",
  features: [
    "Upload and analyze medical report PDFs.",
    "Automatic extraction of lab values and reference ranges.",
    "Highlighting of abnormal results with visual indicators.",
    "Toggle view for all results or only abnormal values.",
    "Natural language question answering using RAG.",
    "Fast semantic search with vector indexing.",
    "Context-restricted AI answers based on report content."
  ]
},
{
  id: "blogging-platform",
  title: "Role-Based Blogging Platform",
  summary: "A role-based blogging web application where users can publish posts and administrators moderate content for security and compliance.",
  tech: [
    "Python",
    "Flask",
    "MySQL",
  ...
  image: "/project/project13.png",
  github: "https://github.com/aishwarya-41/blogging-platform",
  description: "A secure blogging platform that enables users to create and manage blog posts while allowing administrators to monitor, approve, and remove content. The system supports role-based access control, user authentication, and responsive design to ensure a scalable and user-friendly experience.",
  features: [
    "Role-based access for users and administrators.",
    "User dashboard to create, view, and delete blog posts.",
    "Admin dashboard for post monitoring and moderation.",
    "Ability to block or remove inappropriate content.",

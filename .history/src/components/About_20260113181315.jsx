        ...
        <div className="about-content">
          <div className="about-text">
            <p className="about-intro">
              I'm <strong>Aishwarya</strong>, an Artificial Intelligence and Data Science student at Shiv Nadar University, Chennai,
            ...
            <div className="about-details">
              ...
              <div className="detail-item">
                ...
                <p>Skilled in building responsive web applications — from frontend logic to backend integration.</p>
              </div>
          ...
          <div className="about-stats">
            ...
            <div className="stat-item">
              <div className="stat-number">9.17</div>

...
export default function Header() {
  ...
  useEffect(() => {
    const sectionIds = ['about','resume','education','projects','skills','certifications','contact']
      ...
      <div className="nav-wrap">
        ...
        <nav>
          <ul>
            ...
            <li><a className={active===''?'active':''} href="#certifications">Certifications</a></li>
            <li><a className={active==='resume'?'active':''} href="#resume">Resume</a></li>
            <li><Link to="/art">Art Gallery</Link></li>
            {/* <li 
